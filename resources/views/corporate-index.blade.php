...
<nav class="corporate-subnav" aria-label="Explore the company"><a href="{{ route('corporate.about.index') }}">Company</a><a href="{{ route('corporate.leadership.index') }}">Leadership</a><a href="{{ route('corporate.journey.index') }}">Our journey</a><a href="{{ route('corporate.stories.index') }}">Employee stories</a></nav>
