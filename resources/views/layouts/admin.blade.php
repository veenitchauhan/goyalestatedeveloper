...
<main id="main">@if(\App\Models\SiteSetting::where('key','demo_content')->exists())<p class="notice" role="note">Demo dataset loaded. Records prefixed “Demo” are fictional review content. Remove them before deployment with <code>php artisan demo:content --remove</code>.</p>@endif
@if(session('status'))<p class="notice" role="status">{{ match(session('status')) { 'two-factor-authentication-enabled' => 'Scan the code below to finish setting up two-factor authentication.', 'two-factor-authentication-confirmed' => 'Two-factor authentication confirmed. You can now open the overview.', 'two-factor-authentication-disabled' => 'Two-factor authentication disabled.', 'recovery-codes-generated' => 'New recovery codes generated. Previous codes no longer work.', 'password-updated' => 'Your password was updated.', default => session('status') } }}</p>@endif
