...
@php($groups=collect($fields)->reject(fn($value,$key)=>str_starts_with($key,'contact.')||$key==='hero.eyebrow')->groupBy(fn($value,$key)=>str_starts_with($key,'sections.') ? 'sections.'.explode('.',$key)[1] : explode('.',$key)[0]))
