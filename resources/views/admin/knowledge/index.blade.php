...
@section('title','Knowledge & FAQs')
@section('content')
<p class="eyebrow">EDITORIAL WORKSPACE</p><h1>Knowledge & FAQs</h1><p>Publish useful answers and project stories, supported by approved information.</p>
