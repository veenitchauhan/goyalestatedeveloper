...
@section('title','Blog, Knowledge & FAQs')
@section('content')
<p class="eyebrow">EDITORIAL WORKSPACE</p><h1>Blog, Knowledge & FAQs</h1><p>Publish useful answers and project stories, supported by approved information.</p>
@can('pages.create')<a class="button" href="{{ route('admin.knowledge.create') }}">Add content</a>@endcan
@include('admin.knowledge.placement-guide')
