...
@endcan
</form><details><summary>Revision history</summary>@foreach($entry->revisions()->latest('version')->get() as $item)<p>Version {{ $item->version }} · {{ $item->created_at }} @if($entry->published_revision_id===$item->id) · Published @endif</p>@endforeach</details></section> @endif
