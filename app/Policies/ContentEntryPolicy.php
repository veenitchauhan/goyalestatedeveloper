...
class ContentEntryPolicy
{
    private function permitted(User $user, ContentEntry $entry, string $action): bool
    {
        $domain = match ($entry->type) {
            'project' => 'projects', 'job' => 'jobs', 'page','blog','article','knowledge','faq','company_page','business_unit','service','capability','equipment','team_member','company_milestone','employee_story' => 'pages', default => null
        };
