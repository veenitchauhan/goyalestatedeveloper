...
class StoreMediaRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return ['file' => [$this->isMethod('post') ? 'required' : 'nullable', 'file', 'mimes:jpg,jpeg,png,webp,pdf,mp4', 'max:20480'],
            ...
            'publication_status' => 'required|in:draft,published', 'document_category' => 'nullable|in:Company profile,Brochure,Certification,Award,Project document,Policy,Career,Other',
